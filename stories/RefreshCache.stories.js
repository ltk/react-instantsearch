      ...
      >
        <div>
          ...
          <div style={{ color: '#182359', font: 'open sans' }}>
            ...
            <ol>
              <li>
                Type a query in the SearchBox (for instance &apos;cellphones&apos;).
                You should see 10 requests to Algolia (one per letter)
              </li>
              <li>
                Type &apos;cellphones&apos; again, you will see that no additional
